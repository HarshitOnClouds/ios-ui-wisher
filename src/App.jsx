...
import { Calculator, Calendar, Contacts, Music, Photos, Recorder, Settings, Store } from './components/index.js'
...
function App() {
  ...
  return (
    <div className='bg-[url(/mcWallpaper.jpg)] h-screen w-screen bg-cover relative overflow-hidden'>
